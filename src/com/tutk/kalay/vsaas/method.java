...
public class method {
	...
	public void CreateAccount_initialize(int i, String email, String nickname, String pwd1, String pwd2,
		...
		app.driver[i].findElement(By.xpath(app.def.id_password2)).sendKeys(pwd2);
	...
	public void CreateAccount_forCreateAccount_initialize(int i) {
		...
		app.driver[i].findElement(By.xpath(app.def.id_password2)).sendKeys("888888ii");
		app.driver[i].findElement(By.xpath(app.def.id_password1)).sendKeys("888888ii");
